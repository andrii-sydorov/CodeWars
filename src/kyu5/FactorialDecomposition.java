 ...
 * Examples:
 * 
 * n = 12; decomp(12) -> "2^10 * 3^5 * 5^2 * 7 * 11" since 12! is divisible by 2
 * ten times, by 3 five times, by 5 two times and by 7 and 11 only once.
 * 
 ...
 * prime factors in increasing order of the primes, as a string. factorial can
 * be a very big number (4000! has 12674 digits, n can go from 300 to 4000). In
 * Fortran - as in any other language - the returned string is not permitted to
