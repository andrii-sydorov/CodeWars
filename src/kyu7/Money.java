...
public class Money {
    public static void main(String[] args) {
        ...
        double principal = Double.valueOf(sc.nextLine());
        double interest = Double.valueOf(sc.nextLine());
        double tax = Double.valueOf(sc.nextLine());
        double desired = Double.valueOf(sc.nextLine());
        sc.close();
