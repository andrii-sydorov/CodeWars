 ...
 * Explanation:
 * 
 * (6) is divisible by (2) , (6) is less than or equal to bound (7) , and (6) is
 * > 0 .
 * 
 ...
 * Explanation:
 * 
 * (185) is divisible by (37) , (185) is less than or equal to bound (200) , and
 * (185) is > 0 .
 * 
 * @author ASY
 *
...
public class MaximumMultiple {
	public static void main(String[] args) {
		System.out.println("Enter your's bound:");
		Scanner sc = new Scanner(System.in);
		int bound = sc.nextInt();
		System.out.println("Enter your's divisor:");
