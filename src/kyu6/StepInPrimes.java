 ...
 * otherwise nil or null or None or Nothing or [] or "0, 0" or {0, 0} or 0 0 or
 ...
 * For those interested they can have a look at
...
public class StepInPrimes {
    public static void main(String[] args) {
        ...
        sc.close();
        System.out.println(Arrays.toString(step(g, m, n)));
